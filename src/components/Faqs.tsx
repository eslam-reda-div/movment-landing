          ...
          <div className="row justify-content-center mt-5">
            <div className="col-auto icon-with-text-style-08 sm-mb-10px appear anime-complete">
              <div className="feature-box feature-box-left-icon-middle">
                ...
                <div className="feature-box-content">
                  <span className="alt-font text-dark-gray fw-500 fs-18">Looking for help? <a href="#" className="text-decoration-line-bottom text-dark-gray fw-600">Submit a ticket</a></span>
                </div>
              </div>
            </div>
            <div className="col-auto icon-with-text-style-08 appear anime-complete">
              <div className="feature-box feature-box-left-icon-middle">
                ...
                <div className="feature-box-content">
                  <span className="alt-font text-dark-gray fw-500 fs-18">Keep in Touch. <a href="#" className="text-decoration-line-bottom text-dark-gray fw-600">Like us on Facebook</a></span>
                </div>
              </div>
            </div>
          </div>
