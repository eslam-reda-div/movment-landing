        ...
        <div className="container">
          <div className="row row-cols-1 row-cols-md-4 row-cols-sm-2 position-relative z-index-2 justify-content-center counter-style-02">
            ...
            <div className="col text-center sm-mb-30px">
              ...
              >
                <span className="vertical-counter-number" data-to="6">
                  <ul style={{ transform: "translateY(-60%)" }}>
                    <li>0</li>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
                ...
                <span className="vertical-counter-number" data-to="0">
            ...
            <div className="col text-center sm-mb-30px">
              ...
              >
                ...
                <span className="vertical-counter-number" data-to="2">
                ...
                <span className="vertical-counter-number" data-to="9">
                  <ul style={{ transform: "translateY(-90%)" }}>
                    <li>0</li>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
                ...
                <span className="vertical-counter-number" data-to="8">
                  <ul style={{ transform: "translateY(-80%)" }}>
                    <li>0</li>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
            ...
            <div className="col text-center xs-mb-30px">
              ...
              >
                ...
                <span className="vertical-counter-number" data-to="4">
                  <ul style={{ transform: "translateY(-40%)" }}>
                    <li>0</li>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
            ...
            <div className="col text-center">
              <h2
                ...
                style={{ height: "55.0156px" }}
              >
                <span className="vertical-counter-number" data-to="7">
                  <ul style={{ transform: "translateY(-70%)" }}>
                    <li>0</li>
                    <li>1</li>
                    <li>2</li>
                    <li>3</li>
